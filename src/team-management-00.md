...
- **Admin**: Full access. Can manage settings, projects, users, and see all
  errors.
- **Member**: Limited access. Can view and resolve errors in assigned projects
  only.
...
In **Members**, check the box next to a user to make them admin (or uncheck to
demote).
